                                ...
                                <#list model_column?keys as key>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                            <input class="form-control" th:value="${r"$"}{object.data.${model_column[key].ChangeColumnName}} == null?'':${r"$"}{object.data.${model_column[key].ChangeColumnName}}" disabled="disabled"/>
                                        </div>
                                    </div>
                                </#list>
                            </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                        <input class="form-control" disabled="disabled"
                                               th:value="${object.data.${modelName?uncap_first}Details} == null?'':${object.data.${modelName?uncap_first}Details}"/>
                                    </div>
                                </div>
                            </div>
                        </div>
